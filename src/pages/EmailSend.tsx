...
import { ArrowDownSVG, EmailSVG, PlaneSVG, SearchSVG, TrushSVG } from '../components/SVG.js';
import ComposeModal from './ComposeModal.js';
import axios from 'axios';
import EmailDeleteModal from './EmailDeleteModal.js';
...
const EmailSend = () => {
  ...
  return (
    <>
      ...
      <EmailDeleteModal preid={preid} is_deleted={is_deleted} setDelete={setDelete} initPage={initPage} />
            ...
            <tbody>
              {
                emailList.map((memail, emailIndex) => (
                  <tr key={emailIndex}>
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="text-black dark:text-white text-ellipsis4" dangerouslySetInnerHTML={{ __html:memail.subject }}></p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="text-black dark:text-white text-ellipsis3" dangerouslySetInnerHTML={{ __html:memail.content }}></p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <div className="flex items-center space-x-3.5">
                        <button className="hover:text-primary pl-4" onClick={e => { e.preventDefault(); setDelete(true); setPreId(memail.id); }}>
                          <TrushSVG />
                        </button>
                      </div>
                    </td>
