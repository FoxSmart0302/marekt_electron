...
import { ArrowDownSVG, ChartSVG, HumanSVG, SearchSVG, TrushSVG } from '../components/SVG.js';
...
const ChatHistory = () => {
  ...
  return (
    <>
      ...
      <ChatHistoryDeleteModal preid={preid} is_deleted={is_deleted} setDelete={setDelete} initPage={initPage} />
                ...
                historyList.map((history, historyIndex) => (
                  <tr key={historyIndex}>
                    ...
                    <td className="border-b border-[#eee] py-5 px-6 dark:border-strokedark">
                      <p className="text-black dark:text-white text-ellipsis3" dangerouslySetInnerHTML={{ __html: history.message }}></p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <div className="flex items-center space-x-3.5">
                          <button className="hover:text-primary pl-4" onClick={e => { e.preventDefault(); setDelete(true); setPreId(history.id); }}>
                            <TrushSVG />
                          </button>
                        </div>
                      </td>
