            ...
            <tbody>
              {
                jobsList.map((job, jobsIndex) => (
                  <tr key={jobsIndex}>
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="text-black dark:text-white text-ellipsis4" dangerouslySetInnerHTML={{ __html: job.title }}></p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="text-black dark:text-white text-ellipsis3" dangerouslySetInnerHTML={{ __html: job.short_description }}></p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
